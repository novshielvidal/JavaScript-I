...
internTwo.speak = () => console.log("Hello, my name is " + internTwo.name + "!");
...
internFive.multiplyNums = (num1,num2) => num1 * num2;

if (!Number.isNaN()) {
  console.log("Antonietta can multiply two numbers: " + num1 + " * " + num2 + " = " + internFive.multiplyNums(num1, num2));
}
